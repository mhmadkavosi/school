import { AdminTokenCreate } from './admin_token_create';

export class AdminTokenBuilder {
	/**
	 * Builder class for creating an admin token object
	 * @private admin_id The id of the admin
	...
	public setAdminId(admin_id: string): this {
	...
	public async build(): Promise<RestApi.ObjectResInterface> {
		return await new AdminTokenCreate().save(this);
	}
}
